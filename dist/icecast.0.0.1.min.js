...
"use strict";var bluebird=require("bluebird"),Logger=require("../Utils/Logger"),Stream=require("./Stream"),registeredPlayers={},Player=function(){function e(t){if(this.autoplay=!1,t.getAttribute("data-icecast-id"))throw new Error("Audio element is already an Icecast.js instance");this.id=e.generateId(),t.setAttribute("data-icecast-id",this.id),this.elem=t,Logger.Trace("Initializing Icecast for for ",this.elem),this.elem.getAttribute("preload")&&"none"!==this.elem.getAttribute("preload")&&Logger.Warn(this.elem," is set to preload data, this can creates bugs in Icecast.js"),null!==this.elem.getAttribute("autoplay")&&(Logger.Warn(this.elem," is set to autoplay, this can creates bugs in Icecast.js.If you want to autoplay you stream, add the icecast-autoplay attribute."),this.autoplay=!0),null!==this.elem.getAttribute("icecast-autoplay")&&(this.autoplay=!0),this.disableAudio(),this.load()}return e.prototype.getId=function(){return this.id},e.prototype.getSources=function(){var e=[];return this.elem.getAttribute("src")&&e.push({src:this.elem.getAttribute("src")}),[].slice.call(this.elem.querySelectorAll("SOURCE")).filter(function(e){return!!e.getAttribute("icecast-src")}).forEach(function(t){return e.push({src:t.getAttribute("icecast-src"),mimeType:t.getAttribute("mimeType")||void 0})}),e},e.prototype.disableAudio=function(){this.elem.setAttribute("icecast-src",this.elem.getAttribute("src")),this.elem.setAttribute("src",""),[].slice.call(this.elem.querySelectorAll("SOURCE")).forEach(function(e){e.setAttribute("icecast-src",e.getAttribute("src")),e.removeAttribute("src")}),this.elem.pause()},e.prototype.load=function(){return bluebird.map(this.getSources(),function(e){var t=new Stream(e.src,e.mimeType);return t.isValid().then(function(){return t}).catch(function(t){Logger.Info('Cannot play "'+e.src+'": '+(t.message||t))})},{concurrency:5}).then(function(e){return e.filter(function(e){return e&&e.mimeType})}).then(function(e){console.log(e)})},e.RegisterPlayer=function(e){if(registeredPlayers[e.getId()])throw new Error("Player is already registered");registeredPlayers[e.getId()]=e},e.GetRegisteredPlayer=function(e){if(!registeredPlayers[e])throw new Error("Player is not registered");return registeredPlayers[e]},e.IsRegisteredId=function(e){return!!registeredPlayers[e]},e.IsRegisteredPlayer=function(e){return!!Object.keys(registeredPlayers).find(function(t){return registeredPlayers[t]===e})},e.generateId=function(){for(var e="icecast_",t=0;t<10;t+=1)e+=String.fromCharCode(97+Math.floor(25*Math.random()));return e},e}();module.exports=Player;
},{"../Utils/Logger":8,"./Stream":6,"bluebird":1}],6:[function(require,module,exports){
"use strict";var Stream=function(){function e(e,t){this.playlistTypes={"application/xspf+xml":"parseXSPF","audio/x-mpegurl":"parseM3U8","audio/x-vclt":"parseVCLT"},this.playlistEncoding="iso-8859-1";var i=t&&t.split(/\s*;/),r=/(?:^|&)charset=([^&]+)/;if(this.url=e,i&&Array.isArray(i)&&this.playlistTypes[i[0].toLowerCase()]&&(this.playlistMimeType=i[0].toLowerCase(),i[1]&&i[1].match(r))){var s=r.exec(i[1]);this.playlistEncoding=s[1]}}return e.prototype.isValid=function(){return Promise.resolve(1)},Object.defineProperty(e.prototype,"mimeType",{get:function(){return this.playlistMimeType},enumerable:!0,configurable:!0}),e}();module.exports=Stream;
},{}],7:[function(require,module,exports){
"use strict";var events=require("events"),elementCheck=function(e,t){return!("AUDIO"!==t.nodeName||"string"!=typeof t.getAttribute("data-icecast")||"false"===t.getAttribute("data-icecast").toLowerCase()||!e&&t.getAttribute("data-icecast-instance"))};module.exports={GetAudioElements:function(){return[].slice.call(document.getElementsByTagName("audio")).filter(elementCheck.bind(null,!1))},WatchAudioElements:function(){var e=new events.EventEmitter,t=new MutationObserver(function(t){for(var n=0,r=t;n<r.length;n++){for(var i=r[n],a=0,l=[].slice.call(i.addedNodes).filter(elementCheck.bind(null,!1));a<l.length;a++){var c=l[a];e.emit("added",c)}for(var s=0,d=[].slice.call(i.removedNodes).filter(elementCheck.bind(null,!0));s<d.length;s++){var c=d[s];e.emit("removed",c)}}});return t.observe(document.body,{attributes:!0,childList:!0,subtree:!0}),e}};
},{"events":2}],8:[function(require,module,exports){
"use strict";var methods=["assert","clear","dir","Error","group","groupCollapsed","groupEnd","Info","log","profile","profileEnd","table","time","timeEnd","Warn"],EmptyConsole=function(){function o(){}return o.prototype.assert=function(){},o.prototype.clear=function(){},o.prototype.dir=function(){},o.prototype.error=function(){},o.prototype.group=function(){},o.prototype.groupCollapsed=function(){},o.prototype.groupEnd=function(){},o.prototype.info=function(){},o.prototype.log=function(){},o.prototype.profile=function(){},o.prototype.profileEnd=function(){},o.prototype.table=function(){},o.prototype.time=function(){},o.prototype.timeEnd=function(){},o.prototype.warn=function(){},o}(),Logger=function(){function o(){throw new Error("Logger should not be instantiated")}return Object.defineProperty(o,"level",{get:function(){return o.currentLevel},set:function(n){if(n<o.TRACE||n>o.ERROR)throw new Error("Invalid log currentLevel");o.currentLevel=Math.floor(n)},enumerable:!0,configurable:!0}),o.Trace=function(){for(var n=[],e=0;e<arguments.length;e++)n[e-0]=arguments[e];o.log(o.TRACE,n)},o.Debug=function(){for(var n=[],e=0;e<arguments.length;e++)n[e-0]=arguments[e];o.log(o.DEBUG,n)},o.Info=function(){for(var n=[],e=0;e<arguments.length;e++)n[e-0]=arguments[e];o.log(o.INFO,n)},o.Warn=function(){for(var n=[],e=0;e<arguments.length;e++)n[e-0]=arguments[e];o.log(o.WARNING,n)},o.Error=function(){for(var n=[],e=0;e<arguments.length;e++)n[e-0]=arguments[e];o.log(o.ERROR,n)},o.log=function(n,e){var t;if(o.console||o.setupConsole(),!(n<o.currentLevel)){switch(n){case 5:t=o.console.error;break;case 4:t=o.console.warn;break;case 3:t=o.console.info;break;default:t=o.console.log}o.console.group("[ICECAST.JS]"),t.apply(null,e),o.console.groupEnd()}},o.setupConsole=function(){if(o.console=new EmptyConsole,window.console)for(var n=0,e=methods;n<e.length;n++){var t=e[n];"function"==typeof window.console[t]?o.console[t]=window.console[t].bind(window.console):o.console[t]=function(){}}},o.TRACE=1,o.DEBUG=2,o.INFO=3,o.WARNING=4,o.ERROR=5,o.currentLevel=4,o}();module.exports=Logger;
},{}],9:[function(require,module,exports){
"use strict";var DomHelper=require("./Utils/DomHelper"),Player=require("./Icecast/Player"),Logger=require("./Utils/Logger");Logger.level=Logger.TRACE,require("mutationobserver-shim");for(var _i=0,_a=DomHelper.GetAudioElements();_i<_a.length;_i++){var audio=_a[_i];try{new Player(audio)}catch(e){Logger.Error(e)}}DomHelper.WatchAudioElements().on("added",function(e){try{new Player(e)}catch(e){Logger.Error(e)}});
